			...
			<div class="modal-body">
					...
					<div class="row">
						...
						<div class="col-md-4">
							...
							<div class="form-group">
								<label for="exampleInputEmail1">Estocável?(S/N)</label>
								<select required="required" class="form-control sel2" id="stokavel" name="stokavel" style="width:100%;" > 
								<option></option>
					...
					<div class="col-md-4">
						...
						<div class="col-md-4">
							...
							<div class="form-group">
								...
								<input required="required" type="text" class="form-control" id="valor_venda" name="valor_venda" placeholder="Valor Venda" > 
				...
				<div class="modal-footer">      
					<button id="btn" type="submit" class="btn btn-primary">Salvar</button>
				</div>
			</form>
...
<script >
	$(document).ready(function(){
		$("#stokavel").change(function(){
			stocavel=$("#stokavel").val()
			if (stocavel=="0") {
				$("#valor_compra").attr("readonly","readonly");
				
				$("#nivel_estoque").attr("readonly","readonly");
				return false;
			}else{
				$("#valor_compra").attr("readonly",false);
				
				$("#nivel_estoque").attr("readonly",false)
			}
