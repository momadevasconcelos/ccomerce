...
<td>
		...
		<big><a href="#" onclick="mostrar('{$nome}', '{$telefone}', '{$data_cadF}', '{$endereco}')" title="Ver Dados"><i class="fa fa-info-circle text-secondary"></i></a></big>
...
<script type="text/javascript">
	function mostrar(nome, telefone, data_cad, endereco){
