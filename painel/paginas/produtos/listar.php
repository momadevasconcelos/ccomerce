...
echo <<<HTML
	<small>
	<caption><div ><h4>Produtos Estocáveis </h4> </div></caption>
...
<td class="esc">{$valor_compraF}</td>
<td class="esc">MZN {$valor_vendaF}</td>
...
<br>
	<small>
	<caption><div ><h4>Produtos não Estocáveis </h4> </div></caption>
